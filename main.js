...
let projects = [
  {
    image: "textures/Proj1.png",
    url: "https://itsprachit.vercel.app/",
  },
  {
    image: "textures/Proj2.jpg",
    url: "https://github.com/",
  },
  {
    image: "textures/Proj3.png",
    url: "https://prachit.pages.dev/",
  },
  {
    image: "textures/Proj4.png",
    url: "https://wordscramble.pages.dev/",
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load("fonts/unione.json", function (font) {
    ...
    const titleGeo = new TextGeometry("Prachit Pandit", {
      font: font,
      size: 0.08,
      height: 0.02,
    });
  ...
  loader.load("fonts/helvatica.json", function (font) {
    ...
    const subTitleGeo = new TextGeometry("Software Engineer / Web-Developer", {
      font: font,
      size: 0.03,
      height: 0.02,
    });
